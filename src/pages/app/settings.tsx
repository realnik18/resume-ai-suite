...
import { Loader2, User, Shield, CreditCard, Bell } from 'lucide-react';
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get notified when your applications status changes
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive AI-powered tips to improve your resumes
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
